...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=catskill&box=-74.377935,42.109238,-74.595894,41.947542
...
-----------
  ...
  * catskill Height Map (ASTER 30m).png
  ...
  * catskill Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * catskill Height Map (SRTM3 v4.1).png
  ...
  * catskill Height Map (SRTM30 Plus).png
  ...
  * catskill Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 334m (actual) is equal to 40m in
